...
class Reportes extends CI_Controller {
	...
	public function reporte_actividad_transiciones($fecha_inicial,$fecha_final,$usuario=null){
		$session_data = $this->session->userdata('logged_in');	
		if($session_data['tipo']!='1'){
			redirect('home');
		}
		$actividad = $this->_actividadTransiciones($fecha_inicial,$fecha_final,$usuario);
		date_default_timezone_set('America/La_Paz');
		$fecha = date('d-m-Y');
		$hora = date('h:i:s A');
		$date = new DateTime($fecha_inicial);
	...
	public function reporte_actividad_flujos($fecha_inicial,$fecha_final,$usuario = null){
		$session_data = $this->session->userdata('logged_in');	
		if($session_data['tipo']!='1'){
			redirect('home');
		}
		$actividad = $this->_actividadFlujos($fecha_inicial,$fecha_final,$usuario);
		date_default_timezone_set('America/La_Paz');
		$fecha = date('d-m-Y');
		$hora = date('h:i:s A');
		$date = new DateTime($fecha_inicial);
