		...
		<main>			
			...
			<div class="centrado">
				<div class="row">
					<form class="col s12 form-indicadores" action="<?php echo base_url().'indicadores/registrar_indicadores' ?>" method="POST">
				      <div class="row">
				      <h4>Indicadores | <small>Indicadores</small></h4>
				    ...
				    <div class="col s12 m12 l12" id="indicadores"></div>                    
