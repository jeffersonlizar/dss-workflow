		...
		<main>			
			...
			<div class="centrado">
				...
				<section id="principal" class="tab">
                    ...
                    <div class="col s12 m6 l4" id="tiempo_promedio" style="text-align: center;">
                        <div class="titulo tema"></div>
                        <div class="subtitulo tema"></div>
                            <div id="tiempo_horas">   
                                
                                <div class="promedio_dias">
                                    <i class="material-icons md-40">timelapse</i>
                                    <div id="promedio_dias" class="odometer"></div><span> Días</span>
                                </div>
                                <div class="promedio_horas">
                                    <div id="promedio_horas" class="odometer"></div><span> horas</span>
                                </div>
                                <div class="promedio_minutos">
                                    <div id="promedio_minutos" class="odometer"></div><span> minutos</span>
                                </div>
                                <div class="promedio_segundos">
                                    <div id="promedio_segundos" class="odometer"></div><span> segundos</span>
                                </div>
                            </div>
                    </div>
